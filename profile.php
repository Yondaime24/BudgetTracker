        ...
        <div class="card-body">
            ...
            <div class="form-group validate">
              <div class="form-label-group">
                <input type="text" id="inputFullName" class="form-control" placeholder="Full Name" name="name" value="<?php echo $_SESSION['user']['name'] ?>" readonly>
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6 validate">
                  <div class="form-label-group">
                    <input type="text" id="contactNumber" class="form-control" placeholder="Contact Number" name="contact_number" value="<?php echo $_SESSION['user']['contact_number'] ?>" readonly> 
                    <label for="contactNumber">Contact Number:</label>
                  </div>
                </div>
                 <div class="col-md-6 validate">
                  <div class="form-label-group">
                    <input type="text" id="contactNumber" class="form-control" placeholder="Contact Number" name="contact_number" value="<?php echo $_SESSION['user']['gender'] ?>" readonly> 
            ...
            <div class="form-group">
              <div class="form-row">
                <div class="col-md-6 validate">
                  <div class="form-label-group">
                    <input type="email" id="emailAddress" class="form-control" placeholder="Email Address" name="email_address" value="<?php echo $_SESSION['user']['email_address'] ?>" readonly> 
                    <label for="emailAddress">Email Address:</label>
                  </div>
                </div>
                <div class="col-md-6 validate">
                  <div class="form-label-group">
                    <input type="text" id="userName" class="form-control" placeholder="Username" name="username"  value="<?php echo $_SESSION['user']['username'] ?>" readonly>
            ...
            <center>
              <a href="editProfile.php?user_id=<?php echo $_SESSION['user']['user_id'] ?>" class="btn btn-outline-info">Edit Profile</a>
            </center>
        </div>
             <?php }?>
