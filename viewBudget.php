...
<html lang="en">
  ...
  <head>
    ...
    <title>Budget Tracker | View Budget</title>
            ...
            <div class="card-body">
              <div class="table-responsive">
                <?php
                  ...
                  $query = "SELECT * FROM budget WHERE user_id='".$_SESSION['user']['user_id']."'  ORDER BY date_added ASC";
                  ...
                  <tbody>
                    ...
                    if($result){
                      while($res = mysqli_fetch_array($result)) {     
                        ...
                        echo "<td>
                                <a class=\"btn btn-sm btn-block btn-outline-primary\" href=\"editBudget.php?budget_id=$res[budget_id]\"><i class=\"fas fa-fw fa-edit\"></i> EDIT AMOUNT</a> 
                                  <a class=\"btn btn-outline-danger btn-sm btn-block\" onClick=\"return confirm('Are you sure you want to delete this budget?' )\" href=\"budgetDelete.php?budget_id=$res[budget_id]\"><i class=\"fas fa-fw fa-trash\" ></i> DELETE</a>
                              </td>";
                        echo "</tr>";                                   
                      }
                    }?>
